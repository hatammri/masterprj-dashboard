                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input value="{{ $equipment->name }}"  name="name" type="text"
                                    id="basic-icon-default-brand" class="form-control" placeholder="مثال: گیربکس"
                                    aria-label="ACME Inc." aria-describedby="basic-icon-default-brand2">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input value="{{ $equipment->price }}"  name="price" type="text"
                                    id="basic-icon-default-price" class="form-control text-start" placeholder="10,000,000"
                                    aria-label="john.doe" aria-describedby="basic-icon-default-price2" dir="ltr">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input value="{{ $equipment->color }}"  name="color" type="text"
                                    id="basic-icon-default-brand" class="form-control" placeholder="مثال: سفید"
                                    aria-label="ACME Inc." aria-describedby="basic-icon-default-brand2">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-check form-check-inline">
                                <input  type="radio" id="basic-default-radio-male"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input value="{{ $equipment->weight }}"  name="weight"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-brand2" class="input-group-text"><i
                                        class="bx bx-palette"></i></span>
                                <input value="{{ $equipment->dimensions }}"  name="dimensions"
