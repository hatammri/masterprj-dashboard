    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">نوع و تیپ تجهیز /</span> ویرایش نوع و تیپ تجهیز
            </h4>


            <!-- Multi Column with Form Separator -->
            <div class="card mb-4">
                <h5 class="card-header heading-color">ویرایش نوع و تیپ تجهیز </h5>
                <form action="{{ route('typeequipment.update' , ['typeequipment' => $typeequipment->id]) }}" method="POST" class="card-body">
                    @csrf
                    @method('put')                    {{-- <h6 class="fw-normal">1. جزئیات حساب</h6> --}}
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label" for="basic-icon-default-rule">نام نوع و تیپ تجهیز</label>
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-rule2" class="input-group-text"><i
                                        class="bx bx-buildings"></i></span>
                                <input name="name" type="text" id="basic-icon-default-rule" value="{{$typeequipment->name}}"
                                    class="form-control" placeholder="مثال:حلزونی " aria-label="ACME Inc."
