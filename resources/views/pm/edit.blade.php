    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">PM /</span> ویرایش PM /  شناسه  ({{ $pm->id }})
            </h4>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input name="equipment_name" type="text" id="equipment_name" value="{{ $pm->requestworks->equipments->name }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-company2" class="input-group-text"><i
                                        class="bx bx-hard-hat"></i></span>
                                <input name="company_name" type="text" id="company_name" value="{{ $pm->requestworks->customers->companies->name  }}"
                                    class="form-control" placeholder="مثال:گیربکس  " aria-label="ACME Inc."
                                    aria-describedby="basic-icon-default-company2" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-company2" class="input-group-text"><i
                                        class="bx bx-hard-hat"></i></span>
                                <input name="equipment_name_Alias"  value="{{$pm->equipment_name_Alias  }}" type="text" id="basic-icon-default-company"
                                    class="form-control" placeholder="مثال:گیربکس  " aria-label="ACME Inc."
