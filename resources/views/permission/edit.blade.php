    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">permission /</span> ویرایش permission
            </h4>


            <!-- Multi Column with Form Separator -->
            <div class="card mb-4">
                <h5 class="card-header heading-color">ویرایش permission </h5>
                <form action="{{ route('permission.update' , ['permission' => $permission->id]) }}" method="POST" class="card-body">
                    @csrf
                    @method('put')                    {{-- <h6 class="fw-normal">1. جزئیات حساب</h6> --}}
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label" for="basic-icon-default-permission">نام نمایشی</label>
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-permission2" class="input-group-text"><i
                                        class="bx bx-award"></i></span>
                                <input name="display_name" type="text" value="{{$permission->display_name}}" id="basic-icon-default-permission"
                                    class="form-control" placeholder="مثال:ادمین " aria-label="ACME Inc."
                                    aria-describedby="basic-icon-default-permission2">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="basic-icon-default-permission">نام انگلیسی و سیستمی</label>
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-permission2" class="input-group-text"><i
                                        class="bx bx-award"></i></span>
                                <input name="name" type="text" value="{{$permission->name}}" id="basic-icon-default-permission"
                                    class="form-control" placeholder="مثال:admin " aria-label="ACME Inc."
                                    aria-describedby="basic-icon-default-permission2">
                            </div>
                        </div>
                    </div>
