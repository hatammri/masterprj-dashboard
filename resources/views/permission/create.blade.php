    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">permission /</span> ثبت permission جدید
            </h4>


            <!-- Multi Column with Form Separator -->
            <div class="card mb-4">
                <h5 class="card-header heading-color">ثبت permission جدید</h5>
                <form action="{{ route('permission.store') }}" method="POST" class="card-body">
                    @csrf
                    {{-- <h6 class="fw-normal">1. جزئیات حساب</h6> --}}
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label" for="basic-icon-default-brand">نام نمایشی</label>
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-brand2" class="input-group-text"><i
                                        class="bx bx-award"></i></span>
                                <input name="display_name" type="text" {{ old('display_name') }} id="basic-icon-default-brand"
                                    class="form-control" placeholder="مثال:ادمین " aria-label="ACME Inc."
                                    aria-describedby="basic-icon-default-brand2">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="basic-icon-default-brand">نام انگلیسی و سیستمی</label>
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-brand2" class="input-group-text"><i
                                        class="bx bx-award"></i></span>
                                <input name="name" type="text"  {{ old('name') }} id="basic-icon-default-brand"
