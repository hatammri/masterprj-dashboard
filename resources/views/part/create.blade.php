    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 breadcrumb-wrapper mb-4">
                <span class="text-muted fw-light">قطعه /</span> ثبت قطعه جدید
            </h4>
            ...
            <div class="card mb-4">
                ...
                <form action="{{ route('part.store') }}" method="POST" class="card-body">
                    @csrf
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input name="name" type="text" id="basic-icon-default-part"
                                    class="form-control" placeholder="مثال:کاسه‌نمد" aria-label="ACME Inc."
