            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-2">
                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                        ...
                        <span class="badge bg-primary rounded-pill badge-notifications">۴</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end py-0">
                        <li class="dropdown-menu-header border-bottom">
                            <div class="dropdown-header d-flex align-items-center py-3">
                                <h6 class="text-body mb-0 me-auto secondary-font">اعلان‌ها</h6>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                        ...
                        <div class="avatar avatar-online">
                            <img src="{{ asset(env('USER_IMAGES_IMAGES_PATH') . Auth::user()->avatar) }}" alt
                        ...
                        <li>
                            <a class="dropdown-item" href="pages-account-settings-account.html">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar avatar-online">
                                            <img src="{{ asset(env('USER_IMAGES_IMAGES_PATH') . Auth::user()->avatar) }}"
