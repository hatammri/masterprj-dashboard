...
$(function () {
    ...
    if (dt_filter_table.length) {
        ...
        var dt_filter = dt_filter_table.DataTable({
            ajax: {
                url: "http://localhost:8000/machine/datatable",
                type: "GET",
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return (
                            ...
                            full.id +
                            '"' +
                            'class="dropdown-item">ویرایش اطلاعات ماشین' +
                            "</div>" +
                            "</div>" +
                            '<a  href="/machine/edit/' +
                            full.id +
            ...
            buttons: [
                {
                    text: '<i class="bx bx-plus me-md-2"></i><span class="d-md-inline-block d-none">ایجاد ماشین</span>',
